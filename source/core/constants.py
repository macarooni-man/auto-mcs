...
class paths:
    ...
    locales:              str = os.path.join(executable_folder, 'locales') if app_compiled \
                                else os.path.join(executable_folder, '..', 'locales')
    ...
    def __init__(self):
        ...
        self.options_tree = {
            ...
            'Server': [
                ...
                ScreenObject('Back-up Manager', 'ServerBackupScreen', {'Save a back-up now': None, 'Restore from a back-up': None, 'Delete a back-up': None, 'Enable automatic back-ups': 'ServerBackupSettingsScreen', 'Specify maximum back-ups': 'ServerBackupSettingsScreen', 'Specify log retention': 'ServerBackupSettingsScreen', 'Open back-up directory': 'ServerBackupSettingsScreen', 'Migrate back-up directory': 'ServerBackupSettingsScreen', 'Clone this server': 'ServerCloneScreen'}, ['backup', 'revert', 'snapshot', 'restore', 'save', 'clone']),
